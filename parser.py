...
uri = 'http://apps.kanpuruniversity.org/Reg_SubjectUpdate/Result/MBBSNewResult2016.aspx'
...
formFields = (
   ...
   (r'__VIEWSTATE', r''),
   ...
   #(r'ctl00$ContentPlaceHolder1$chkOptions$2', 'on'),  # attachement
                                                       # etc. (not all listed)
   (r'txtrollno', '6081001'),   # Search text
   (r'ddlcourse', 'M.B.B.S'),  # Years to include
   (r'ddlsem', 'FIRST PROFESSIONAL (Oct 2016)'),  #types to include
   (r'btnsubmit', 'Go')  # Search button itself
)
